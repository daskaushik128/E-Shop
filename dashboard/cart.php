        ...
        <div class="container d-flex align-items-center justify-content-around">
            ...
            <nav class="nav-menu d-none d-lg-block">
                <div class="logo text-center">
                    <img src="../img/cart.png" alt="" class="img-fluid"><span>E-Shop</span>
                </div>
                <hr>
                <?php
                include "./sidebar.php";
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        ...
                        <div class="input-group-prepend">
                            ...
                            <input type="text" class="form-control" id="name1" name="name1" placeholder="Your Full Name"
                                required="">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6">
                    ...
                    <div class="col-lg-12 col-md-12 mx-auto text-center my-3"> <button
                            class="btn btn-danger text-uppercase" type="submit" name="export"><i
                                class="fas fa-download"></i>
                            download &nbsp; paysilp</button> </div>
                </div>
            </form>
